let pokemonRepository = (function () {
  ...
  function showModal(item) {
    pokemonRepository.loadDetails(item).then(function () {
      ...
      let pokeLogo = $('<img class="modal-header__logo">').attr(
        'src',
        'src/img/svg-pokemon-logo.png'
      );
      let pokeImage = $('<img class="modal-item__img" alt="">').attr(
        'src',
        item.imageUrl
      );
      ...
      let pokeName = $(
        '<h2 class="modal-body__headline headline-secondary">' +
          item.name +
          '</h2>'
      );
      let pokeHeight = $(
        '<p class="modal-body__item--height">' +
          '<b>Height: </b>' +
          item.height +
          '</p>'
      );
      ...
      let typesElement = $(
        '<p class="modal-body__item--types">' +
          '<b>Types: </b>' +
          pokeTypes +
          '</p>'
      );
